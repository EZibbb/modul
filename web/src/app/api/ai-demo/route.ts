...
ФОРМАТ ОТВЕТА: обычный текст, БЕЗ Markdown (никаких **, ##, списков, маркеров). Максимум 2-3 коротких предложения. НЕ перечисляй характеристики, артикулы и цены — они показаны в карточках под ответом. Только вывод: что взять основным, что альтернативой, и одна уточняющая мысль при необходимости.
